...
namespace windows
{
    ...
    public:
        ...
        static auto process_any_message(HWND hwnd, std::uint32_t msg, WPARAM wparam, LPARAM lparam) -> LRESULT;

    private:
        static auto process_btn_message(HWND hwnd, std::uint32_t code, core::input::state state) -> void;
    };
